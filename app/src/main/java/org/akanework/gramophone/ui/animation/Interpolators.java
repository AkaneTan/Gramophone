...
import org.akanework.gramophone.logic.utils.MathUtils;
...
public class Interpolators {
    ...
    public static float getOvershootInterpolation(float progress, float overshootAmount,
        ...
        float b = (float) (Math.log((overshootAmount + 1) / (overshootAmount)) / overshootStart);
    ...
    public static float getOvershootInterpolation(float progress) {
        return Math.max(0.0f, (float) (1.0f - Math.exp(-4 * progress)));
    }
